...
class AlcoholRestControllerTest {
    ...
    void 주류리스트_조회_성공() throws Exception {
        // given
        List<AlcoholDto> alcohols = List.of(new AlcoholDto(AlcoholName.from("맥주"), Keyword.HONEY, Category.BEER, 0, 0));
    ...
    void 주류리스트_상세조회_성공() throws Exception {
        // given
        long alcoholId = 1;
        AlcoholDto beer = new AlcoholDto(AlcoholName.from("맥주"), Keyword.HONEY, Category.BEER, 0, 0);
